...
def _run_suite_with_config(
    ...
    reporter = SuiteProgress(
        ...
        observed_model=model_probe.model if model_probe.status == "observed" else None,
        observed_source="startup_probe" if model_probe.status == "observed" else None,
        model_hint=model_probe.model if model_probe.status == "configured" else None,
        model_hint_source=model_probe.detail if model_probe.status == "configured" else None,
