...
class SuiteProgress:
    ...
    def event(self, task_id: str, task_index: int, event_name: str, payload: dict[str, object]) -> None:
        ...
        if event_name == "repetition.finished":
            ...
            self._complete_attempt(float(duration) if isinstance(duration, (int, float)) else None)
    ...
    def complete_external_task(self, duration_seconds: float | None) -> None:
        ...
        for _ in range(self.repetitions):
            self._complete_attempt(per_attempt)
    ...
    def finish(self, status: str = "complete") -> None:
        ...
        with self._lock:
            ...
            self._persist_locked()
            if self.interactive and self._last_line_was_live:
    ...
    def _complete_attempt(self, duration_seconds: float | None) -> None:
        with self._lock:
