...
- Added a baseline/reference corpus audit. It found two tasks whose baseline already passes acceptance and one test-writing task without a reference artifact; all three were marked `needs_rework` and removed from comparative scorecards.
